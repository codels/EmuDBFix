UPDATE `gossip_menu_option` SET `action_script_id` = 0 WHERE `menu_id` = 342 AND `id` = 1;
...
(@NPC_JANENE, 0, 0, 3, 62, 0, 100, 0, 342, 1, 0, 0, 85, 24751, 0, 0, 0, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0, 'Invoker self cast'),
(@NPC_JANENE, 0, 3, 0, 61, 0, 100, 0, 0, 0, 0, 0, 72, 0, 0, 0, 0, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0, 'Close gossip'),
(@NPC_BRIANNA, 0, 0, 3, 62, 0, 100, 0, 342, 1, 0, 0, 85, 24751, 0, 0, 0, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0, 'Invoker self cast'),
(@NPC_BRIANNA, 0, 3, 0, 61, 0, 100, 0, 0, 0, 0, 0, 72, 0, 0, 0, 0, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0, 'Close gossip'),
(@NPC_ALLISON, 0, 0, 3, 62, 0, 100, 0, 342, 1, 0, 0, 85, 24751, 0, 0, 0, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0, 'Invoker self cast'),
(@NPC_ALLISON, 0, 3, 0, 61, 0, 100, 0, 0, 0, 0, 0, 72, 0, 0, 0, 0, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0, 'Close gossip'),
(@NPC_TRELAYNE, 0, 0, 3, 62, 0, 100, 0, 342, 1, 0, 0, 85, 24751, 0, 0, 0, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0, 'Invoker self cast'),
(@NPC_TRELAYNE, 0, 3, 0, 61, 0, 100, 0, 0, 0, 0, 0, 72, 0, 0, 0, 0, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0, 'Close gossip'),
(@NPC_HEATHER, 0, 0, 3, 62, 0, 100, 0, 342, 1, 0, 0, 85, 24751, 0, 0, 0, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0, 'Invoker self cast'),
(@NPC_HEATHER, 0, 3, 0, 61, 0, 100, 0, 0, 0, 0, 0, 72, 0, 0, 0, 0, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0, 'Close gossip'),
(@NPC_CHRISTINA, 0, 0, 3, 62, 0, 100, 0, 342, 1, 0, 0, 85, 24751, 0, 0, 0, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0, 'Invoker self cast'),
(@NPC_CHRISTINA, 0, 3, 0, 61, 0, 100, 0, 0, 0, 0, 0, 72, 0, 0, 0, 0, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0, 'Close gossip'),
(@NPC_JENNIFER, 0, 0, 3, 62, 0, 100, 0, 342, 1, 0, 0, 85, 24751, 0, 0, 0, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0, 'Invoker self cast'),
