...
`action_param4`, `action_param5`, `action_param6`, `target_type`, `target_param1`, `target_param2`, `target_param3`, `target_x`, `target_y`,
`target_z`, `target_o`, `comment`) VALUES
(@NPC, 0, 0, 0, 6, 0, 100, 0, 0, 0, 0, 0, 11, 71203, 3, 0, 0, 0, 0, 18, 45, 0, 0, 0, 0, 0, 0, 'Cast Soul Feast when death'),
(@NPC, 0, 1, 0, 0, 0, 100, 0, 6500, 7000, 15000, 20000, 11, 71022, 1, 0, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0, 'Cast Disrupting Shout'),
(@NPC, 0, 2, 0, 0, 0, 100, 0, 2000, 3000, 2000, 3500, 11, 71021, 0, 0, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0, 'Cast Saber Lash');
