...
`action_param4`, `action_param5`, `action_param6`, `target_type`, `target_param1`, `target_param2`, `target_param3`, `target_x`, `target_y`,
`target_z`, `target_o`, `comment`) VALUES
(@NPC, 0, 0, 0, 6, 0, 100, 1, 0, 0, 0, 0, 11, 71203, 3, 0, 0, 0, 0, 18, 45, 0, 0, 0, 0, 0, 0, 'Deathspeaker Servant - Cast Soul Feast on death'),
(@NPC, 0, 1, 0, 0, 0, 100, 0, 2500, 4000, 7500, 15000, 11, 69405, 1, 0, 0, 0, 0, 5, 0, 0, 0, 0, 0, 0, 0, 'Deathspeaker Servant - Cast Consuming Shadows'),
(@NPC, 0, 2, 0, 0, 0, 100, 10, 500, 3000, 7500, 10000, 11, 69404, 1, 0, 0, 0, 0, 5, 0, 0, 0, 0, 0, 0, 0, 'Deathspeaker Servant - Cast Curse of Agony'),
(@NPC, 0, 3, 0, 0, 0, 100, 10, 1500, 2000, 2600, 2700, 11, 69576, 0, 0, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0, 'Deathspeaker Servant - Cast Chaos Bolt'),
(@NPC, 0, 4, 0, 0, 0, 100, 20, 500, 3000, 5000, 75000, 11, 71112, 1, 0, 0, 0, 0, 5, 0, 0, 0, 0, 0, 0, 0, 'Deathspeaker Servant - Cast Curse of Agony'),
(@NPC, 0, 5, 0, 0, 0, 100, 20, 1500, 2000, 2600, 2700, 11, 71108, 0, 0, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0, 'Deathspeaker Servant - Cast Chaos Bolt');
