...
(@NPC, -1595015, 'Anak\'Keri...', 'Анак\'Кери...', 14422, 1, 0, 'mal_ganis SAY_SLAY_1'),
(@NPC, -1595016, 'My onslaught will wash over the Lich King\'s forces...', 'Мой натиск сметет силы Короля Лича...', 14423, 1, 0, 'mal_ganis SAY_SLAY_2'),
(@NPC, -1595017, 'Your death is in vain, tiny mortal...', 'Твоя смерть была напрасна, насекомое...', 14424, 1, 0, 'mal_ganis SAY_SLAY_3'),
(@NPC, -1595018, 'Your time has come to an end!', 'Твое время вышло!', 14425, 1, 0, 'mal_ganis SAY_SLAY_4'),
...
(@NPC, -1595021, 'I spent too much time in that weak little shell...', 'Я и так провел слишком много времени в этой слабой оболочке...', 14426, 1, 0, 'mal_ganis SAY_30HEALTH'),
(@NPC, -1595022, '(Eredun) I AM MAL\'GANIS! I AM ETERNAL!', 'Ирел\'нарак. Я МАЛ\'ГАНИС! Я ВЕЧЕН!', 14427, 1, 0, 'mal_ganis SAY_15HEALTH'),
(@NPC, -1595023, 'ENOUGH! I waste my time here...I must gather my strength on the home world...', 'Я лиш зря трачу тут свое время... Мне нужно собраться с силами в своем родном мире...', 14428, 1, 0, 'mal_ganis SAY_ESCAPE_SPEECH_1'),
(@NPC, -1595024, 'You\'ll never defeat the Lich King without my forces! I\'ll have my revenge...on him, AND you...', 'Тебе не когда не победить Короля Лича без моих войск! Я отомщу... и тебе, И ему...', 14429, 1, 0, 'mal_ganis SAY_ESCAPE_SPEECH_2'),
