...
' упить двойную специализацию талантов.', NULL, NULL, NULL, NULL, NULL, NULL, NULL,
'¬ы уверены что хотите купить двойную специализацию талантов?');
...
'ƒвойна€ специализаци€ позвол€ет иметь доступ к двум наборам талантов. ѕри переключении между ними вы получаете доступ ко второму набору символов и панелей команд. ѕереключение невозможно во врем€ бо€ и оно потребует всех ваших сил.',
...
UPDATE `locales_gossip_menu_option` SET `option_text_loc8` = 'я хочу узнать больше об учении —вета.' WHERE `menu_id` = 6647 AND `id` = 0;
...
UPDATE `locales_gossip_menu_option` SET `option_text_loc8` = 'ƒа. я желаю.' WHERE `menu_id` = 4461 AND `id` = 0;
UPDATE `script_texts` SET `content_loc8` = '„то? Ётого не может быть!' WHERE `entry` = -1595091;