...
(@NPC, -1601012, 'You were foolish to come.', 'Придти сюда было глупо с твоей стороны.', 14077, 1, 0, 0, 'SAY_SLAY_1'),
(@NPC, -1601013, 'As Anub\'Arak commands!', 'По приказу Ануб\'Арака!', 14078, 1, 0, 0, 'SAY_SLAY_2'),
...
(@NPC, -1601018, 'I hear footsteps. Be on your guard.', 'Я слышу шаги. Будьте на чеку.', 14083, 1, 0, 0, 'SAY_PREFIGHT_2'),
(@NPC, -1601019, 'I sense the living. Be ready.', 'Я чувствую живых. Приготовится.', 14084, 1, 0, 0, 'SAY_PREFIGHT_3'),
...
(@NPC, -1601021, 'We must hold the gate. Attack! Tear them limb from limb!', 'Мы должны защищать ворота. В атаку! Разорвите их на части!', 14080, 1, 0, 0, 'SAY_SEND_GROUP_2'),
